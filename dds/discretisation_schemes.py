...
def exp_fn_step_scheme(start, end, dt, base=2.71828, dtype=np.float32, **_):
...
def cos_sq_fn_step_scheme(start, end, dt, s=0.008, dtype=np.float32, **_):
...
def linear_step_scheme(start, end, dt, dt_min=0.0001, dtype=np.float32, **_):
...
def linear_step_scheme_dds(
    start, end, dt, dt_max=0.04, dt_min=0.02, dtype=np.float32, **_
):
...
def uniform_step_scheme_dds(start, end, dt, dt_max=0.02, dtype=np.float32, **_):
    """Linear step scheme for Ho et al 2020 applied to sampling.
